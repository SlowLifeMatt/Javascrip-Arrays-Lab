...
let addFood = foods.splice(2,0, 'tofu')
...
let removeFood = foods.splice(1,1, 'sushi' , 'cupcake' )
...
// Two different methods for same answer
let total = 0
